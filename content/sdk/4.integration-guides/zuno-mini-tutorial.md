...
::tabs
  ...
  ::div{label="Tutorial"}
    ...
    **Tutorial Complete!** You've built a fully functional NFT marketplace with:
    ...
    - Explore [SDK Reference](/sdk/reference) for all available hooks
    - Check [Recipes](#tab-recipes) tab for quick patterns
    - Read [Integration Reference](/sdk/4.integration-guides/zuno-mini-reference) for architecture details
  ::
