...
::card-grid
  ::card{icon="i-heroicons-queue-list" title="Batch Operations" to="/sdk/advanced/batch-operations"}
  Execute multiple operations efficiently with batch APIs
  ::
  ::card{icon="i-heroicons-layer-group" title="ERC1155 Support" to="/sdk/advanced/erc1155-support"}
  Multi-token listings with automatic detection
  ::
  ::card{icon="i-heroicons-wrench-screwdriver" title="DevTools" to="/sdk/advanced/devtools"}
  In-app debugging panel for development
  ::
  ::card{icon="i-heroicons-beaker" title="Testing" to="/sdk/advanced/testing"}
  Test your SDK integration with examples
  ::
  ::card{icon="i-heroicons-server" title="SSR Support" to="/sdk/advanced/ssr-support"}
